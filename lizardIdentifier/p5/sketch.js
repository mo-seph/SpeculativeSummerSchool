...
const responses = {
  human: {
    ...
    images: ["images/person1.webp", "images/person2.jpg", "images/person3.webp"],
  },
  lizard: {
    stories: [
      // > please write a 30 word piece of advice for a lizard person trying to pretend to be human
    ...
    images: ["images/lizard1.webp", "images/lizard2.webp", "images/lizard3.jpg"],
  },
};
...
function draw_classifying() {
  ...
  if (!model) {
    ...
    // Really draw the classification
